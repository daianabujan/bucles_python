...
inicio = int(input('Ingrese el primer nº de la secuencia\n'))
fin = int(input('Ingrese el último nº de la secuencia\n'))
...
for i in range(inicio, fin +1):
    cantidad_numeros +=1
    print('La cantida de números es =', cantidad_numeros)
