...
print('La máxima temp fue = ', temperatura_max)
print('La menor temp fue = ', temperatura_min)
print('La cantidad de temp relevadas fue de = ', temperatura_len)
print('La suma de todas las temp fue de = ', round(temperatura_sumatoria, 2))

# Al finalizar el bucle debe calcular el promedio como:
temperatura_promedio = temperatura_sumatoria / temperatura_len
print('La temp promedio fue = ', round(temperatura_promedio, 2))
...
print('La temperatura máxima con función es = ', max(temp_dataloger))
print('La temperatura mínima con función es = ', min(temp_dataloger))
print('La suma de las temperaturas con función da = ', round(sum(temp_dataloger), 2))
...
if (temperatura_min >= 19) and (temperatura_max <= 28):
    print('La temporada del muestreo fue VERANO')
elif (temperatura_min >= 11) and (temperatura_max <= 20):
    print('La temporada del muestreo fue OTOÑO')
elif (temperatura_min >= 8) and (temperatura_max <= 14):
    print('La temporada del muestreo fue INVIERNO')
elif (temperatura_min >= 10) and (temperatura_max <= 24):
    print('La temporada del muestreo fue PRIMAVERA')